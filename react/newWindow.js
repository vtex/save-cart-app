// Imported from https://github.com/rmariuzzo/react-new-window version 0.0.9
...
class NewWindow extends React.PureComponent {
  ...
  static defaultProps = {
    ...
    name: '',
    title: '',
    features: { width: '1000px', height: '1000px' },
    onBlock: null,
    onUnload: null,
    center: 'parent',
    copyStyles: true,
  ...
  render() {
    ...
    return ReactDOM.createPortal(this.props.children(this.window), this.container)
  }
